"""logintest_29319 URL Configuration
...
admin.site.site_header = "loginTest"
admin.site.site_title = "loginTest Admin Portal"
admin.site.index_title = "loginTest Admin"

# swagger
api_info = openapi.Info(
    title="loginTest API",
    default_version="v1",
    description="API documentation for loginTest App",
)
